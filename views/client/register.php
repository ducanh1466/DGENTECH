    ...
    <div class="auth-card" style="max-width:480px;">
        ...
        <form method="POST" action="">
            ...
            <div class="form-check mb-3">
                ...
                <label class="form-check-label text-secondary" for="agreeTerms" style="font-size:0.85rem;">
                    Tôi đồng ý với <a href="#" class="text-accent">Điều khoản dịch vụ</a> và <a href="#" class="text-accent">Chính sách bảo mật</a>
                </label>
            </div>
        ...
        <button class="btn btn-outline-secondary w-100 rounded-pill py-2" style="font-size:0.9rem;">
        ...
        <p class="text-center mt-3" style="font-size:0.9rem;">
            Đã có tài khoản? <a href="<?= BASE_URL ?>?action=login" class="fw-bold text-gradient">Đăng nhập</a>
        </p>
    </div>
</section>
